...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/monetio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9353&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/monetio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `monetio` can be installed with:

```
conda install monetio
```

It is possible to list all of the versions of `monetio` available on your platform with:
